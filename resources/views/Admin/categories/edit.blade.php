            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">Update Loại Sản Phẩm
                        <a href="{{route('categories.index')}}" class="float-right">Back</a>
                    </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('categories.update',$category->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user @error('name') is-invalid @enderror" name="name" value="{{ old('name',$category->name) }}"
                        ...
                        <div class="form-group">
                            ...
                            <img with="50" height="50" src="{{"/storage/$category->image"}}" alt="">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user @error('desc') is-invalid @enderror" name="desc" value="{{ old('desc',$category->desc) }}"
                                required autocomplete="name" autofocus id="exampleInputName"
                                placeholder="Mô tả">
